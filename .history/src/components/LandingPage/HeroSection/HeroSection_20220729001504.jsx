      ...
      <div className={styles["grid-container"]}>
        ...
        <div className={`${styles["grid-item"]} ${styles["two"]}`}>
          <div className={styles['video-container']}>
            <video 
            // https://ak.picdn.net/shutterstock/videos/1046439025/preview/stock-footage-puerto-vallarta-jalisco-mexico-january-traditional-folklore-dance-with-beautiful.webm
            src={'../../../../public/vid.mp4'}
            autoPlay
            loop
            muted
